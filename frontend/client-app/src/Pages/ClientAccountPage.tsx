            ...
            <div style={{
              ...
              <nav style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                {[
                  ...
                  { id: 'bookings', label: '🗺️ Мои туры', badge: '2' },
                  { id: 'favorites', label: '❤️ Избранное', badge: '3' },
                  { id: 'reviews', label: '⭐ Мои отзывы', badge: '1' },
              ...
              <div style={{
                ...
                <div style={{ fontSize: '18px', fontWeight: 'bold' }}>1,250 баллов</div>
                <div style={{ fontSize: '12px', marginTop: '5px', opacity: 0.9 }}>
                  До следующего уровня: 250 баллов
                </div>
              </div>
            </div>

            {/* Правая колонка - информация/форма */}
            <div style={{
              background: 'rgba(255, 248, 240, 0.8)',
              backdropFilter: 'blur(10px)',
              borderRadius: '30px',
              ...
              <section style={{ marginBottom: '30px' }}>
                ...
                {isEditing ? (
                  ...
                  // Режим просмотра - отображаем данные клиента
                  <div style={{
                    background: '#FFF8F0',
                    borderRadius: '20px',
                    padding: '20px',
